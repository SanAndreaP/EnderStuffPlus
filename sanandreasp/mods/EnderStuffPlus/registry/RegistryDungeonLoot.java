	...
	public static boolean placeLootChest(World world, int x, int y, int z, String lootID, Random rand, int attempts) {
		...
		if( chest != null ) {
            ...
            for( int j = 0; j < attempts; ++j ) {
                ...
                int k = weightedItem.theMinimumChanceToGenerateItem + rand.nextInt(weightedItem.theMaximumChanceToGenerateItem - weightedItem.theMinimumChanceToGenerateItem + 1);
