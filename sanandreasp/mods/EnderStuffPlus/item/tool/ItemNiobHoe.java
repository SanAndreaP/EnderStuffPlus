...
public class ItemNiobHoe extends ItemHoe {
	...
	private Block[] getPlants() {
		if( effectiveBlocks.size() > 0 )
			return this.effectiveBlocks.toArray(CUS.getArrayFromList(this.effectiveBlocks, Block.class));
		...
		return blocks.toArray(CUS.getArrayFromList(blocks, Block.class));
	}
