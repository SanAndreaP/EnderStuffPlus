...
public class ItemNiobDoor extends Item {
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            block = ESPModRegistry.blockNiobDoor;
    ...
    public static void placeDoorBlock(World par0World, int par1, int par2, int par3, int par4, Block par5Block)
    {
        ...
        par0World.setBlock(par1, par2 + 1, par3, par5Block.blockID, 8, 2);
        par0World.setBlock(par1, par2 + 2, par3, par5Block.blockID, 8 | (flag2 ? 1 : 0), 2);
        par0World.notifyBlocksOfNeighborChange(par1, par2, par3, par5Block.blockID);
        par0World.notifyBlocksOfNeighborChange(par1, par2 + 1, par3, par5Block.blockID);
        par0World.notifyBlocksOfNeighborChange(par1, par2 + 2, par3, par5Block.blockID);
    }
}
