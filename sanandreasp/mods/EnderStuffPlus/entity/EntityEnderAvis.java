...
public class EntityEnderAvis extends EntityCreature implements IEnderPet, IEnderCreature, Textures {
	private static final UUID entityUUID = UUID.fromString("4B25FAFA-06D7-4C34-A99D-2E8C48D07219");
    private static final AttributeModifier attributes = (new AttributeModifier(entityUUID, "Attacking speed boost", 3.199999809265137D, 0)).setSaved(false);
