...
public class GuiWeatherAltar extends GuiScreen implements Textures {
	...
	protected static SAPLanguageManager langman = ESPModRegistry.manHelper.getLangMan();
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.btnSun = new GuiButton(this.buttonList.size(), this.guiLeft + 10, this.guiTop + 75, 66, 20, langman.getTranslated("enderstuffplus.weatherAltar.sun")));
        this.buttonList.add(this.btnRain = new GuiButton(this.buttonList.size(), this.guiLeft + 10+67, this.guiTop + 75, 66, 20, langman.getTranslated("enderstuffplus.weatherAltar.rain")));
        this.buttonList.add(this.btnStorm = new GuiButton(this.buttonList.size(), this.guiLeft + 10+134, this.guiTop + 75, 66, 20, langman.getTranslated("enderstuffplus.weatherAltar.thunder")));
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		this.fontRenderer.drawString(langman.getTranslated("tile.enderstuffp:weatherAltar.name"), this.guiLeft + 6, this.guiTop + 6, 0x808080);
        this.fontRenderer.drawString(langman.getTranslated("enderstuffplus.weatherAltar.duration"), this.guiLeft + 12, this.guiTop + 35, 0x808080);
