    ...
    extends GuiBiomeChangerBase
{
    ...
    public GuiBiomeChangerBiomes(TileEntityBiomeChanger tileBiomeChanger) {
        ...
        for( int i = 0, j = 0; i < BiomeGenBase.getBiomeGenArray().length; i++ ) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        this.mc.getTextureManager().bindTexture(Textures.GUI_BIOMECHANGER_II.getResource());
        ...
        GL11.glPushMatrix();
          ...
          for( int i = this.entryPosition; i < 14 + this.entryPosition; i++ ) {
              ...
              if( i + this.entryPosition < this.biomeList.size() ) {
                  ...
                  this.fontRendererObj.drawString(s, x + 15, y + 2, 0xFFFFFF);
