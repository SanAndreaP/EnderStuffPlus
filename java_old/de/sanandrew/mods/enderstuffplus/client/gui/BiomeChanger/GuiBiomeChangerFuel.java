    ...
    extends GuiBiomeChangerBase
{
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        this.fontRendererObj.drawString(rangeText, this.xSize - 8 - this.fontRendererObj.getStringWidth(rangeText), 96, 0x808080);
        ...
        for( int i = this.entryPosition; i < 4 + this.entryPosition && i < this.fuelEntries.size(); i++ ) {
            ...
            itemRender.renderItemIntoGUI(this.fontRendererObj, this.mc.renderEngine, stack, x, y);
            ...
            RenderHelper.disableStandardItemLighting();
            this.fontRendererObj.drawString(String.format("items needed: %s", needed), 28, y + 4, !isAvailable ? 0x404040 : 0x5500BB);
        }
