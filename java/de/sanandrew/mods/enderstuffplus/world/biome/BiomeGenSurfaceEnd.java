package de.sanandrew.mods.enderstuffplus.world.biome;
...
import de.sanandrew.mods.enderstuffplus.world.WorldGenEndTree;
...
//        this.maxHeight = 10.0F;
        this.setHeight(new BiomeGenBase.Height(-1.0F, 10.0F));
