...
public final class RaincoatManager
{
    ...
    public static final List<ItemStack> BASE_STACKS = new ArrayList<>(6);
    public static final List<ItemStack> COLOR_STACKS = new ArrayList<>(19);
    ...
    public static void initialize() {
        ...
        baseNiob = addBase(EnderStuffPlus.MOD_ID, "niobium", 0x3C408B, "textures/entity/enderMiss_cape/stripes_niob.png",
                           "textures/entity/enderAvis_cape/stripes_niob.png", new ItemStack(/*ModBlockRegistry.enderBlock*/Blocks.grass, 1, 0)
        );
        ...
        baseTantal = addBase(EnderStuffPlus.MOD_ID, "tantalum", 0xFF81E8, "textures/entity/enderMiss_cape/stripes_tant.png",
                             "textures/entity/enderAvis_cape/stripes_tant.png", new ItemStack(/*ModBlockRegistry.enderBlock*/Blocks.grass, 1, 1)
        );
