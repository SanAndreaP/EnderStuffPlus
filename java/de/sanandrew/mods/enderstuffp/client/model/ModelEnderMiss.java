...
public class ModelEnderMiss
        extends ModelBiped
{
    private ModelRenderer bodyCoat;
...
//        super(0.0F, -14.0F, 64, 32);
        ...
        this.bipedHead = SAPClientUtils.createNewBox(this, 0, 0, false, -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F, -13.5F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedHead = new ModelRenderer();
//        this.bipedHead.addBox();
//        this.bipedHead.setRotationPoint();

        this.bipedHeadwear = SAPClientUtils.createNewBox(this, 0, 16, false, -4.0F, -8.0F, -4.0F, 8, 8, 8, -0.5F, 0.0F, -13.5F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedHeadwear = new ModelRenderer();
//        this.bipedHeadwear.addBox();
//        this.bipedHeadwear.setRotationPoint();

        this.bipedBody = SAPClientUtils.createNewBox(this, 32, 16, false, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, -14.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedBody = new ModelRenderer();
//        this.bipedBody.addBox(0.0F);
//        this.bipedBody.setRotationPoint();

        this.bodyCoat = SAPClientUtils.createNewBox(this, 32, 16, false, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, -14.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bodyCoat = new ModelRenderer();
//        this.bodyCoat.addBox(0.0F);
//        this.bodyCoat.setRotationPoint();

        this.bipedRightArm = SAPClientUtils.createNewBox(this, 64, 0, true, -1.0F, -2.0F, -1.0F, 2, 30, 2, -3.0F, -12.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedRightArm = new ModelRenderer();
//        this.bipedRightArm.addBox(0.0F);
//        this.bipedRightArm.setRotationPoint();

        this.bipedLeftArm = SAPClientUtils.createNewBox(this, 64, 0, false, -1.0F, -2.0F, -1.0F, 2, 30, 2, 5.0F, -12.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedLeftArm = new ModelRenderer();
//        this.bipedLeftArm.mirror = true;
//        this.bipedLeftArm.addBox(, 0.0F);
//        this.bipedLeftArm.setRotationPoint();

        this.bipedRightLeg = SAPClientUtils.createNewBox(this, 56, 0, true, -1.0F, 0.0F, -1.0F, 2, 30, 2, -2.0F, -4.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedRightLeg = new ModelRenderer();
//        this.bipedRightLeg.addBox(0.0F);
//        this.bipedRightLeg.setRotationPoint();

        this.bipedLeftLeg = SAPClientUtils.createNewBox(this, 56, 0, false, -1.0F, 0.0F, -1.0F, 2, 30, 2, 2.0F, -4.0F, 0.0F, 0.0F, 0.0F, 0.0F);
//        this.bipedLeftLeg = new ModelRenderer();
//        this.bipedLeftLeg.mirror = true;
//        this.bipedLeftLeg.addBox(0.0F);
//        this.bipedLeftLeg.setRotationPoint();
    }
    ...
    private void drawSkirt(float limbSwing, float limbSwingAmount, float partTicks) {
        ...
        if( !this.isSitting ) {
            GL11.glPushMatrix();
            GL11.glRotatef(this.bipedBody.rotateAngleY * 180.0F / (float) Math.PI, 0.0F, 1.0F, 0.0F);
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAmount, float rotFloat, float rotYaw, float rotPitch, float partTicks) {
        ...
        if( this.isCaped ) {
            ...
            GL11.glPushMatrix();                            // bipedRightArm
              ...
              GL11.glRotatef(this.bipedRightArm.rotateAngleZ * (180.0F / (float) Math.PI), 0.0F, 0.0F, 1.0F);
              GL11.glRotatef(this.bipedRightArm.rotateAngleY * (180.0F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
              GL11.glRotatef(this.bipedRightArm.rotateAngleX * (180.0F / (float) Math.PI), 1.0F, 0.0F, 0.0F);
            ...
            GL11.glRotatef(this.bipedLeftLeg.rotateAngleZ * (180.0F / (float) Math.PI), 0.0F, 0.0F, 1.0F);
            GL11.glRotatef(this.bipedLeftLeg.rotateAngleY * (180.0F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
            GL11.glRotatef(this.bipedLeftLeg.rotateAngleX * (180.0F / (float) Math.PI), 1.0F, 0.0F, 0.0F);
            this.bipedLeftLeg.rotateAngleZ = this.bipedLeftLeg.rotateAngleY = this.bipedLeftLeg.rotateAngleX = 0.0F;
            GL11.glTranslatef(-0.015F, !this.isSitting ? 0.0F : -0.015F, 0.0F);
            GL11.glTranslatef(-this.bipedLeftLeg.rotationPointX * partTicks, -this.bipedLeftLeg.rotationPointY * partTicks,
                              -this.bipedLeftLeg.rotationPointZ * partTicks);
            GL11.glScalef(1.1F, 1.01F, 1.1F);
            ...
            GL11.glPushMatrix();                            // bipedRightLeg
              ...
              GL11.glRotatef(this.bipedRightLeg.rotateAngleZ * (180.0F / (float) Math.PI), 0.0F, 0.0F, 1.0F);
              GL11.glRotatef(this.bipedRightLeg.rotateAngleY * (180.0F / (float) Math.PI), 0.0F, 1.0F, 0.0F);
              GL11.glRotatef(this.bipedRightLeg.rotateAngleX * (180.0F / (float) Math.PI), 1.0F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float rotFloat, float rotYaw, float rotPitch, float partTicks, Entity entity) {
        ...
        this.bipedBody.rotateAngleX = this.bodyCoat.rotateAngleX = 0.0F;
        this.bipedBody.rotationPointY = this.bodyCoat.rotationPointY = -14.0F;
        this.bipedBody.rotationPointZ = this.bodyCoat.rotationPointZ = 0.0F;
