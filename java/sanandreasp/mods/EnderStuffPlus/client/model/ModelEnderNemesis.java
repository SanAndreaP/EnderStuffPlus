...
public class ModelEnderNemesis extends ModelEnderman
{
	...
	public ModelEnderNemesis() {
		...
		setRotation(this.rightWing, -0.0523599F, 1.099557F, 0.2443461F);
		...
		setRotation(this.leftWing, 0.1396263F, -0.7504916F, -0.0872665F);
		...
		setRotation(this.heart, 0F, 0F, 0F);
	}
	
	@Override
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		super.render(entity, f, f1, f2, f3, f4, f5);
		setRotation(this.rightWing, 0.1523599F, 0.699557F, 0.2443461F);
