...
{
	public ModelRenderer body, neck, bodyTailM, bodyTailL, bodyTailR, head, headTailM, beak1, beak2, rightLeg, leftLeg;
	public ModelRenderer rightFoot, leftFoot, leftWingBone, leftWing, rightWingBone, rightWing, headTailL, headTailR;
