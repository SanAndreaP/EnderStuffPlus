...
{
	public ModelRenderer bipedHeadwear, bipedBody, bipedRightArm, bipedLeftArm, headHorn1, headHorn2, backHorn, bipedHead;
	...
	private void setLivingAnimation(float limbSwing, float limbSwingAmount, float rotFloat, float rotYaw, float rotPitch, float partTicks) {
		...
		this.headHorn1.rotateAngleY = this.headHorn2.rotateAngleY = this.bipedHead.rotateAngleY;
		this.headHorn1.rotateAngleX = this.headHorn2.rotateAngleX = 2.181662F + this.bipedHead.rotateAngleX;
