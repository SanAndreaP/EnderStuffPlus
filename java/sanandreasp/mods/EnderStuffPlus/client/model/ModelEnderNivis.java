    ...
    extends ModelBase
{
    ...
    private void setLivingAnimation(float limbSwing, float limbSwingAmount, float rotFloat, float rotYaw,
        ...
        this.bipedRightArm2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 2.0F * limbSwingAmount
                                           * 0.5F;
        ...
        this.bipedLeftLeg.rotateAngleX = -0.5235988F + MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F
                                         * limbSwingAmount;
        this.bipedRightLeg.rotateAngleY = 0.0F;
        this.bipedLeftLeg.rotateAngleY = 0.0F;
        this.bipedRightLeg1.rotateAngleX = -1.832596F + MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
        this.bipedLeftLeg1.rotateAngleX = -1.832596F + MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F
                                          * limbSwingAmount;
        ...
        this.bipedLeftLeg2.rotateAngleX = -0.2617994F + MathHelper.cos(limbSwing * 0.6662F + 3.141593F) * 1.4F
                                          * limbSwingAmount;
        ...
        if( this.heldItemRight != 0 ) {
            this.bipedRightArm2.rotateAngleX = this.bipedRightArm2.rotateAngleX * 0.5F - 0.3141593F
                                               * this.heldItemRight;
        }
