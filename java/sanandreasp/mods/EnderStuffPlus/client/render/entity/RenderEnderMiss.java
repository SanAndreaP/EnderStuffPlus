...
public class RenderEnderMiss extends RenderLiving implements Textures
{
	...
	protected void renderFlower(EntityEnderMiss miss, float partTicks) {
		...
		if( !miss.canGetFallDmg() ) {
			...
			this.renderManager.itemRenderer.renderItem(miss, new ItemStack(ItemRegistry.avisFeather), 0);

			if( heldStack.getItem().isFull3D() ) {
				this.renderManager.itemRenderer.renderItem(miss, new ItemStack(ItemRegistry.avisFeather), 1);
			}
...
//        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, brightX / 1.0F, brightY / 1.0F);
//
//        this.renderManager.itemRenderer.renderItem(miss, new ItemStack(Item.swordDiamond), 0);
//
//        if( heldStack.getItem().isFull3D() ) {
//            this.renderManager.itemRenderer.renderItem(miss, new ItemStack(Item.swordDiamond), 1);
//        }
//
//        OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, lastBrightX, lastBrightY);
//
