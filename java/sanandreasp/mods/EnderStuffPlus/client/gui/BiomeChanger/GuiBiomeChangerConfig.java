...
public class GuiBiomeChangerConfig extends GuiBiomeChangerBase implements Textures {
	...
	public void initGui() {
		...
		this.buttonList.add(this.btn_circular = new GuiButton(buttonList.size(), this.guiLeft + 13, this.guiTop + 70, 50, 20, translate("enderstuffplus.biomeChanger.gui3.form1")));
		this.buttonList.add(this.btn_square = new GuiButton(buttonList.size(), this.guiLeft + 13 + 50, this.guiTop + 70, 50, 20, translate("enderstuffplus.biomeChanger.gui3.form2")));
		this.buttonList.add(this.btn_rhombic = new GuiButton(buttonList.size(), this.guiLeft + 13 + 100, this.guiTop + 70, 50, 20, translate("enderstuffplus.biomeChanger.gui3.form3")));
		this.buttonList.add(this.btn_chngBlocks = new GuiButton(buttonList.size(), this.guiLeft + 13, this.guiTop + 100, 150, 20, translate("enderstuffplus.biomeChanger.gui3.blocks")));
	}
