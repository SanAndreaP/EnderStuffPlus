...
//	public static final ResourceLocation ENDERMISS_CAPE_TEXTURE			= new ResourceLocation("enderstuffp", "textures/entities/enderMissCape.png");
//	public static final ResourceLocation ENDERMISS_CAPESTR_TEXTURE		= new ResourceLocation("enderstuffp", "textures/entities/enderMissCapeStripes.png");
//	public static final ResourceLocation ENDERAVIS_CAPE_TEXTURE			= new ResourceLocation("enderstuffp", "textures/entities/enderAvisCape.png");
//	public static final ResourceLocation ENDERAVIS_CAPESTR_TEXTURE		= new ResourceLocation("enderstuffp", "textures/entities/enderAvisCapeStripes.png");
	...
	public static final ResourceLocation ENDERMISS_GLOW_TEXTURE_SPEC	= new ResourceLocation("enderstuffp", "textures/entities/enderMissSpecGlow.png");
	public static final ResourceLocation ENDERAVIS_TEXTURE				= new ResourceLocation("enderstuffp", "textures/entities/enderAvis.png");
	public static final ResourceLocation ENDERAVIS_TEXTURE_SADDLE		= new ResourceLocation("enderstuffp", "textures/entities/enderAvisSaddle.png");
	public static final ResourceLocation ENDERAVIS_GLOW_TEXTURE			= new ResourceLocation("enderstuffp", "textures/entities/enderAvisGlow.png");
	public static final ResourceLocation ENDERIGNIS_TEXTURE				= new ResourceLocation("enderstuffp", "textures/entities/enderIgnis.png");
	public static final ResourceLocation ENDERIGNIS_GLOW_TEXTURE		= new ResourceLocation("enderstuffp", "textures/entities/enderIgnisGlow.png");
	public static final ResourceLocation ENDERNIVIS_TEXTURE				= new ResourceLocation("enderstuffp", "textures/entities/enderNivis.png");
	public static final ResourceLocation ENDERNIVIS_GLOW_TEXTURE		= new ResourceLocation("enderstuffp", "textures/entities/enderNivisGlow.png");
	public static final ResourceLocation ENDERRAY_TEXTURE				= new ResourceLocation("enderstuffp", "textures/entities/enderRay.png");
	public static final ResourceLocation ENDERRAY_TEXTURE_SPEC			= new ResourceLocation("enderstuffp", "textures/entities/enderRayScars.png");
	public static final ResourceLocation ENDERRAY_GLOW_TEXTURE			= new ResourceLocation("enderstuffp", "textures/entities/enderRayGlow.png");
...
//	public static final ResourceLocation TEX_ARMOR_NIOBIUM_1			= new ResourceLocation("EnderStuffP", "textures/armor/niob_1.png");
//	public static final ResourceLocation TEX_ARMOR_NIOBIUM_2			= new ResourceLocation("EnderStuffP", "textures/armor/niob_2.png");
	...
	public static final ResourceLocation ENDERMISS_CAPES_CLR[] = new ResourceLocation[] {
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/green.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/brown.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/blue.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/purple.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/cyan.png"),
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/orange.png"),
	...
	public static final ResourceLocation ENDERMISS_CAPES_STR[] = new ResourceLocation[] {
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/stripes_iron.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderMiss_cape/stripes_reds.png"),
	...
	public static final ResourceLocation ENDERAVIS_CAPES_CLR[] = new ResourceLocation[] {
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/green.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/brown.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/blue.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/purple.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/cyan.png"),
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/orange.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/white.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/gold.png"),
	...
	public static final ResourceLocation ENDERAVIS_CAPES_STR[] = new ResourceLocation[] {
		...
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/stripes_iron.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/stripes_reds.png"),
		new ResourceLocation("enderstuffp", "textures/entities/enderAvis_cape/stripes_obsd.png")
	};
}
