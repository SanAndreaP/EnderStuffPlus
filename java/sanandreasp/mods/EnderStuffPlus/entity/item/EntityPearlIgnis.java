    ...
    protected void onImpact(MovingObjectPosition movingObjPos) {
        ...
        for( int i = 0; i < 8; i++ ) {
            ESPModRegistry.sendPacketAllRng("fxPortal", this.posX, this.posY, this.posZ, 128D, this.dimension,
                                            this.posX, this.posY, this.posZ, 1.0F, 0.3F, 0.0F, this.width, this.height);
        }
        ...
        if( !this.worldObj.isRemote ) {
            if( movingObjPos.typeOfHit == EnumMovingObjectType.TILE && this.getThrower() instanceof EntityPlayer ) {
                    ...
                    for( int j = -3; j <= 3; j++ ) {
                        for( int k = -3; k <= 3; k++ ) {
                            ...
                            if( blockID == Block.ice.blockID ) {
                                ...
                                this.worldObj.notifyBlockOfNeighborChange(movX + i,
                                                                          movY + j,
                                                                          movZ + k,
                                                                          this.worldObj.getBlockId(movX + i, movY + j
                                                                                                             + 1, movZ
                                                                                                                  + k));
                                ...
                                if( Block.blocksList[bID1] != null
                                    && Block.blocksList[bID1].isFlammable(this.worldObj, movX + i, movY + j + 1, movZ
                                                                                                                 + k,
                                                                          this.worldObj.getBlockMetadata(movX + i, movY
                                                                                                                   + j
                                                                                                                   + 1,
                                                                                                         movZ + k),
                                                                          ForgeDirection.DOWN) ) {
                                    ...
                                    playSound = true;
                                } else if( Block.blocksList[bID2] != null
                                           && Block.blocksList[bID2].isFlammable(this.worldObj,
                                                                                 movX + i,
                                                                                 movY + j - 1,
                                                                                 movZ + k,
                                                                                 this.worldObj.getBlockMetadata(movX
                                                                                                                        + i,
                                                                                                                movY
                                                                                                                        + j
                                                                                                                        - 1,
                                    ...
                                    this.worldObj.setBlock(movX + i, movY + j, movZ + k, Block.fire.blockID);
                                    playSound = true;
                                } else if( Block.blocksList[bID3] != null
                                           && Block.blocksList[bID3].isFlammable(this.worldObj,
                                                                                 movX + i + 1,
                                                                                 movY + j,
                                                                                 movZ + k,
                                                                                 this.worldObj.getBlockMetadata(movX
                                    ...
                                    this.worldObj.setBlock(movX + i, movY + j, movZ + k, Block.fire.blockID);
                                    playSound = true;
                                } else if( Block.blocksList[bID4] != null
                                           && Block.blocksList[bID4].isFlammable(this.worldObj,
                                                                                 movX + i - 1,
                                                                                 movY + j,
                                                                                 movZ + k,
                                                                                 this.worldObj.getBlockMetadata(movX
                                    ...
                                    this.worldObj.setBlock(movX + i, movY + j, movZ + k, Block.fire.blockID);
                                    playSound = true;
                                } else if( Block.blocksList[bID5] != null
                                           && Block.blocksList[bID5].isFlammable(this.worldObj,
                                                                                 movX + i,
                                                                                 movY + j,
                                                                                 movZ + k + 1,
                                                                                 this.worldObj.getBlockMetadata(movX
                                    ...
                                    this.worldObj.setBlock(movX + i, movY + j, movZ + k, Block.fire.blockID);
                                    playSound = true;
                                } else if( Block.blocksList[bID6] != null
                                           && Block.blocksList[bID6].isFlammable(this.worldObj,
                                                                                 movX + i,
                                                                                 movY + j,
                                                                                 movZ + k - 1,
                                                                                 this.worldObj.getBlockMetadata(movX
                ...
                if( playSound ) {
                    this.worldObj.playSoundEffect(movX, movY, movZ, "fire.ignite", 1.0F,
