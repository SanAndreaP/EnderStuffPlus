    ...
    extends ItemSpade
{
    ...
    public ItemNiobShovel(int id, EnumToolMaterial toolMaterial) {
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        this.glowMap = iconRegister.registerIcon(ESPModRegistry.MOD_ID + ":niobShovelGlow" + (ConfigRegistry.useNiobHDGlow ? "HD" : ""));
    }
