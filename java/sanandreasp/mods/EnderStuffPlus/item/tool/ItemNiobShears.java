...
public class ItemNiobShears extends ItemShears {
    ...
    public boolean onBlockStartBreak(ItemStack itemstack, int x, int y, int z, EntityPlayer player)
    {
    	...
    	if( this.getShearable(itemstack, player.worldObj, x, y, z).contains(Block.blocksList[id]) || id == Block.deadBush.blockID ) {
            ...
            for( ItemStack item : drops )
            {
		    	...
		    	if( newStack != null ) {
		    		...
		    		if( newStack == null ) {
	                    ...
	                    EntityItem entityitem = new EntityItem(player.worldObj, x + d, y + d1, z + d2, item);
    ...
    {
        return ItemRegistry.TOOL_NIOBIUM.getEnchantability();
    }
