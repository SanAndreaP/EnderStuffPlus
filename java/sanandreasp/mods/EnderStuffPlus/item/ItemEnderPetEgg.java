...
public class ItemEnderPetEgg extends Item {
    ...
    public String getItemDisplayName(ItemStack par1ItemStack)
    {
        ...
        String var3 = getEnderPetName(par1ItemStack);
    ...
    private String getEnderPetName(ItemStack par1ItemStack) {
    	...
    	if( !pets.containsKey(petID) ) petID = 0;
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if( spawnEnderPet(par3World, par1ItemStack, getEnderPetName(par1ItemStack), (double)par4 + 0.5D, (double)par5 + var12, (double)par6 + 0.5D, par2EntityPlayer.username) )
            {
    ...
    public static boolean spawnEnderPet(World par0World, ItemStack par1ItemStack, String par2EntityName, double par3PosX, double par4PosY, double par6PosZ, String par7PlayerName)
    {
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer player, List par2List, boolean b) {
    	if( par1ItemStack.hasTagCompound() ) {
    		...
    		if( par1ItemStack.getItemDamage() == 0 ) {
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.health"), (int)(nbt.getFloat("missHealth") / 40F * 100F) + "%"));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.hasSpecSkin"), nbt.getBoolean("missSpecial") ? StatCollector.translateToLocal("enderstuffplus.petegg.true") : StatCollector.translateToLocal("enderstuffplus.petegg.false")));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.immuneToH2O"), nbt.hasKey("missCoatColor") && nbt.hasKey("missCoatBase") ? StatCollector.translateToLocal("enderstuffplus.petegg.true") : StatCollector.translateToLocal("enderstuffplus.petegg.false")));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.fallDmg"), nbt.getBoolean("missNoFallDmg") ? StatCollector.translateToLocal("enderstuffplus.petegg.true") : StatCollector.translateToLocal("enderstuffplus.petegg.false")));
    		} else if( par1ItemStack.getItemDamage() == 1 ) {
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.health"), (int)(nbt.getFloat("avisHealth") / 40F * 100F) + "%"));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.condition"), (int)((float)nbt.getFloat("avisCondition") * 10F) + "%"));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.saddle"), nbt.getBoolean("avisSaddle") ? StatCollector.translateToLocal("enderstuffplus.petegg.true") : StatCollector.translateToLocal("enderstuffplus.petegg.false")));
    			par2List.add(String.format("%s: \2473%s", StatCollector.translateToLocal("enderstuffplus.petegg.immuneToH2O"), nbt.hasKey("avisCoatColor") && nbt.hasKey("avisCoatBase") ? StatCollector.translateToLocal("enderstuffplus.petegg.true") : StatCollector.translateToLocal("enderstuffplus.petegg.false")));
    		}
    	}
    }
